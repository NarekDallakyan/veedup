package am.varmtech.veedup.controller;
...
import am.varmtech.veedup.R;
import am.varmtech.veedup.apprtc.callback.PeerConnectionEvents;
import am.varmtech.veedup.apprtc.manager.AppRTCAudioManager;
import am.varmtech.veedup.apprtc.client.AppRTCClient;
import am.varmtech.veedup.apprtc.client.DirectRTCClient;
import am.varmtech.veedup.apprtc.client.PeerConnectionClient;
import am.varmtech.veedup.apprtc.exception.UnhandledExceptionHandler;
import am.varmtech.veedup.apprtc.callback.UpdateEncoderCallBack;
import am.varmtech.veedup.apprtc.client.WebSocketRTCClient;
import am.varmtech.veedup.apprtc.callback.OnCallEventsCallBack;
...
public class CallControllerCallBack implements AppRTCClient.SignalingEvents,
        PeerConnectionEvents,
        OnCallEventsCallBack {
    ...
    public OnCallEventsCallBack getEventListener() {
        return this;
    }
    ...
    private UpdateEncoderCallBack encoderListener;
    ...
    public void setPipRenderer(@Nullable SurfaceViewRenderer pipRenderer) {
        this.pipRenderer = pipRenderer;
    }

    public void setFullscreenRenderer(@Nullable SurfaceViewRenderer fullscreenRenderer) {
        this.fullscreenRenderer = fullscreenRenderer;
    }

    public void setEncoderListener(UpdateEncoderCallBack encoderListener) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (!isError && connected) {
                    encoderListener.updateEncoderStatistics(reports);
                }
            }
        });
    }
    ...
    private void startCall() {
        ...
        logAndToast(activity.getString(R.string.connecting_to, roomConnectionParameters.roomUrl));
    ...
    private boolean useCamera2() {
        return Camera2Enumerator.isSupported(activity) && intent.getBooleanExtra(EXTRA_CAMERA2, true);
    }
