...
package com.varmtech.veedapp.apprtc.client;
...
import com.varmtech.veedapp.apprtc.controller.RecordedAudioToFileController;
import com.varmtech.veedapp.apprtc.util.RtcEventLog;
...
public class PeerConnectionClient {
    ...
    public static class PeerConnectionParameters {
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback,
                                        boolean tracing, int videoWidth, int videoHeight,
                                        int videoFps, int videoMaxBitrate, String videoCodec,
                                        boolean videoCodecHwAcceleration, boolean videoFlexfecEnabled,
                                        int audioStartBitrate, String audioCodec,
                                        boolean noAudioProcessing, boolean aecDump,
                                        boolean saveInputAudioToFile, boolean useOpenSLES,
    ...
    private void createMediaConstraintsInternal() {
        ...
        Log.i(TAG, "createMediaConstraintsInternal: " + sdpMediaConstraints);
    }
    ...
    private void createPeerConnectionInternal() {
        ...
        if (dataChannelEnabled && peerConnection != null) {
        ...
        if (isVideoCallEnabled() && peerConnection != null) {
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onRenegotiationNeeded() {
            ...
            Log.i(TAG, "onRenegotiationNeeded: received");
        }
    ...
    private class SDPObserver implements SdpObserver {
        ...
        public void onCreateSuccess(final SessionDescription origSdp) {
            ...
            executor.execute(() -> {
                if (peerConnection != null && !isError) {
                    Log.d(TAG, "Set local SDP from " + sdp.type + " spd description: " + sdp.description);
        ...
        public void onCreateFailure(final String error) {
            Log.i(TAG, "onCreateFailure: SDP " + error);
            reportError("createSDP error: " + error);
        }

        @Override
        public void onSetFailure(final String error) {
            Log.i(TAG, "onSetFailure: SDP " + error);
