...
import com.varmtech.veedapp.apprtc.RoomParametersFetcher;
import com.varmtech.veedapp.apprtc.manager.AsyncRequestManager;
...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelClient.WebSocketChannelEvents {
  ...
  private void sendPostMessage(
    ...
    AsyncRequestManager httpConnection =
        new AsyncRequestManager("POST", url, message, new AsyncRequestManager.AsyncHttpEvents() {
          @Override
