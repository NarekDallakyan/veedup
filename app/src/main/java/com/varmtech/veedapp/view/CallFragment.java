...
import com.varmtech.veedapp.apprtc.controller.CaptureQualityController;
...
public class CallFragment extends Fragment {
    ...
    private OnCallEventsCallBack callEvents;
    ...
    public void onStart() {
        ...
        if (args != null) {
            String contactName = args.getString(CallControllerCallBack.EXTRA_ROOMID);
            contactView.setText(contactName);
            videoCallEnabled = args.getBoolean(CallControllerCallBack.EXTRA_VIDEO_CALL, true);
            captureSliderEnabled = videoCallEnabled
                    && args.getBoolean(CallControllerCallBack.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
            callEvents = (OnCallEventsCallBack) args.getSerializable("eventCallback");
        }
        if (!videoCallEnabled) {
